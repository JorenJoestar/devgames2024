...
// Define this to enable writing to a blob.
#define IDRA_BLOB_WRITE
...
#if defined IDRA_BLOB_WRITE
    void                set( char* raw_pointer );
    void                set_null();
#endif // IDRA_BLOB_WRITE
...
struct RelativeString : public RelativeArray<char> {
    ...
    void                    set( const StringView data )        { RelativeArray<char>::set( ( char* )data.data, (u32)data.size ); }
